      ...
      >
        <div className={`rounded-2xl shadow-xl overflow-hidden ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
          ...
          <div className={`p-6 text-center ${darkMode ? 'bg-gradient-to-r from-gray-700 to-gray-800' : 'bg-gradient-to-r from-blue-600 to-indigo-700'}`}>
            ...
            <p className={`text-sm ${darkMode ? 'text-gray-300' : 'text-blue-100'}`}>Join us today and get started</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-8 space-y-5">
            ...
            <div>
              <label htmlFor="firstName" className={`block text-sm font-medium mb-1 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                Full Name
              </label>
              ...
              {errors.firstName && (
                <p className={`mt-1 text-sm ${darkMode ? 'text-red-400' : 'text-red-600'}`}>{errors.firstName.message}</p>
              )}
            </div>
